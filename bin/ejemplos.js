...
//write("Hola, ") // esta linea falla porque el write tiene que aceptar multiples parametros


//-----2-Sentencias----------------------------------------------------------------
//b = 8 + 6
//i = i > 88 
//sumar(b, n - 8) //llamada a funcion
//b = fun1 (9)
//c = b + fun2 (b, fun3() - 8)
//return j + j
...
//-----Operador asignacion, logico, realcion, aritmetico-------------------------
//t = a + 1
//t = a - 1
//t = a > 1
//t = a && b
...
//	
	...
	switch (dia)
	{
		...
		//case 3: max = (dia > 2 && dia > 7) ? ("Miercoles") : ("?"); break
